#!/bin/bash
# A/B: fp8 (v12-like) với max_num_batched_tokens = 2048/2144/3216/4096.
...
echo "########## A/B max-num-batched-tokens 2048/2144/3216/4096 (fp8) — $REPS reps ##########"
for rep in $(seq 1 $REPS); do
  run_one b2048 "$rep"; run_one b2144 "$rep"; run_one b3216 "$rep"; run_one b4096 "$rep"
done
kill_server
echo "ALL_DONE  ->  $OUT"